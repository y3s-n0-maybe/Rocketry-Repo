...
sustainer_radius = 0.079/2
booster_radius = 0.09/2

total_length = 1.99
sustainer_length = 1.22
nose_length = 0.318

booster_motor_length = 0.245
booster_motor_dry_mass = .204
booster_motor_total_mass = .392
booster_motor_giir = 0.00725
booster_motor_or = 0.038/2
booster_motor_grain_number = 3
...
sustainer_motor_length = 0.245
sustainer_motor_dry_mass = .204
sustainer_motor_total_mass = .392
sustainer_motor_giir = 0.00725
sustainer_motor_or = 0.038/2
sustainer_motor_grain_number = 3
...
varDate = datetime.datetime(2026, 5, 30, hour = 12)

env =  Environment(latitude = 54.307, longitude = -5.571, date = varDate)
...
booster = Rocket(
    center_of_mass_without_motor = (total_length - 1.06),
    coordinate_system_orientation = "tail_to_nose",
    power_off_drag = booster_drag,
    power_on_drag = booster_drag,
    inertia = [0.69, 0.69, 0.003],
    mass = 2.04 + sustainer_motor_total_mass,
    radius = booster_radius

)

sustainer = Rocket(
    center_of_mass_without_motor = sustainer_length - 0.71,
    coordinate_system_orientation = "tail_to_nose",
    power_off_drag = sustainer_drag,
    power_on_drag = sustainer_drag,
    inertia = [0.14, 0.14, 0.0018],
    mass = 1.24,
...
booster.add_surfaces([transition, nose, sustainer_fins], [total_length-sustainer_length, total_length, total_length - sustainer_length + 0.13])

sustainer.add_parachute(
    name = "Sustainer Main", 
    cd_s = 0.8 * 3.1415926 * ((.457/2)**2),
    trigger = "apogee",
    sampling_rate = 1,
    lag = 0
    )
...
sustainer.add_surfaces([nose, sustainer_fins], [sustainer_length, .13])
